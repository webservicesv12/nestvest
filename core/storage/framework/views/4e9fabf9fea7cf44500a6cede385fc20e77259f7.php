                    ...
                    <div class="card-body">
                        <ul class="list-group">
                            ...
                            <li class="list-group-item text-light">
                                ...
                                <span class="w-100">
                                    <img src="<?php echo e(getFile('gateways', @$gateway->gateway_parameters->qr_code)); ?>" alt="">
                                </span>
                            </li>
                        </ul>
                    </div>
                    ...
                    <div class="card-body">
                        <ul class="list-group">
                            ...
                            <li class="list-group-item  text-light d-flex justify-content-between">
                                ...
                                <span><?php echo e($deposit->final_amount *$deposit->rate  . ' ' . @$deposit->gateway->gateway_parameters->gateway_currency); ?></span>
                            </li>
                        </ul>
                    </div>
                            ...
                            <div class="row">
                                ...
                                <div class="form-group">
                                    <button class="cmn-btn mt-4"
                                        type="submit"><?php echo e(__('Deposit Now')); ?></button>
...
<?php echo $__env->make(template().'layout.master2', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/sites/nestvest-mgmt/core/resources/views/frontend/user/gateway/gateway_manual.blade.php ENDPATH**/ ?>