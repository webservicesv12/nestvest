                    ...
                    <form action="" method="post" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-md-3 mb-3">
                                <label class="col-form-label"><?php echo e(__('CoinPayment Image')); ?></label>
                            ...
                            <div class="col-md-9">
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-md-12">
                                        ...
                                        <label for=""><?php echo e(__('Coinpayments Public Key')); ?></label>
                                        <input type="text" name="public_key" class="form-control"
                                            
                                            value="<?php echo e(@$gateway->gateway_parameters->public_key ?? old('public_key')); ?>">
                                    </div>

                                    <div class="form-group col-md-12">

                                        <label for=""><?php echo e(__('Coinpayments Private Key')); ?></label>
                                        <input type="text" name="private_key" class="form-control"
                                            
                                            value="<?php echo e(@$gateway->gateway_parameters->private_key ?? old('private_key')); ?>">
                                    </div> 
                                    <div class="form-group col-md-12">

                                        <label for=""><?php echo e(__('Coinpayments Merchant Id')); ?></label>
                            ...
                            <div class="col-md-12">
                                <button type="submit" class="btn btn-primary float-right"><?php echo e(__('Update CoinPayment Information')); ?></button>
                            </div>
...
<?php echo $__env->make('backend.layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\hyip_v7\core\resources\views/backend/gateways/coin.blade.php ENDPATH**/ ?>