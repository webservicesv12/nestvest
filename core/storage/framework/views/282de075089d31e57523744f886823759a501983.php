                        ...
                        <div class="col-md-4 pe-lg-5 pe-md-4 justify-content-center">
                            <div class="img-choose-div">
                                ...
                                <label for="imageUpload"
                                    class="editImg cmn-btn w-100"><?php echo e(_('Choose file')); ?></label>
...
<?php echo $__env->make(template().'layout.master2', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/sites/nestvest-mgmt/core/resources/views/frontend/user/profile.blade.php ENDPATH**/ ?>