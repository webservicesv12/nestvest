...
<?php $__env->startSection('content'); ?>
    <div class="main-content">
        <section class="section">
            ...
            <div class="mb-4">
                <code class="mb-2 d-inline-block text-info">
                ...
                <div class="input-group">
                    ...
                    <div class="input-group-append">
                        <button class="input-group-text bg-primary text-white copy" type="button"
...
<?php echo $__env->make('backend.layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/sites/nestvest-mgmt/core/resources/views/backend/dashboard.blade.php ENDPATH**/ ?>