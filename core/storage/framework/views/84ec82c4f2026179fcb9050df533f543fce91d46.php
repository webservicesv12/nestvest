                    ...
                    <?php $__empty_1 = true; $__currentLoopData = $transactions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $transaction): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <tr>
                            ...
                            <td data-caption="<?php echo e(__('Upcoming Payment')); ?>">
                                <p id="count_<?php echo e($loop->iteration); ?>" class="mb-2"></p>
                                <script>
                                    getCountDown("count_<?php echo e($loop->iteration); ?>", "<?php echo e(now()->diffInSeconds($transaction->next_payment_date)); ?>")
                                </script>
                            </td>
                        </tr>
...
<?php echo $__env->make(template() . 'layout.master2', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/sites/nestvest-mgmt/core/resources/views/frontend/user/invest_log.blade.php ENDPATH**/ ?>