    ...
    <section class="auth-section auth-section-two">
        <div class="auth-wrapper">
            <div class="auth-top-part">
                ...
                <p class="mb-0"><span class="me-2"><?php echo e(__('Already registered?')); ?></span> <a class="cmn-btn btn-sm" href="<?php echo e(route('user.login')); ?>"><?php echo e(__('Login')); ?></a></p>
            </div>
                    ...
                    <form action="<?php echo e(route('user.register')); ?>" method="POST">
                        ...
                        <div class="row gy-4">
                            <div class="col-lg-12">
                                ...
                                <input type="text" class="form-control bg-dark"  value="<?php echo e(request()->reffer); ?>" name="reffered_by"  placeholder="<?php echo e(__('Reffered By')); ?>" readonly>
                                <?php endif; ?>
                            </div>
                            <div class="col-md-6">
...
<?php echo $__env->make(template().'layout.auth', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/sites/nestvest-mgmt/core/resources/views/frontend/user/auth/register.blade.php ENDPATH**/ ?>