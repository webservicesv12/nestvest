                ...
                <div class="card-body">
                    <div class="row">
                        <div class="custom-xxl-3 col-xl-4 col-lg-5">
                            ...
                            <form action="<?php echo e(route('admin.user.invest.update', $user->id)); ?>" method="post">
                                <?php echo csrf_field(); ?>
                                <div class="input-group mb-3">
                                    <input type="hidden" class="form-control" name="user_id" value="<?php echo e($user->id); ?>">
                                    <input type="hidden" class="form-control" name="type" value="add">
                                    <select name="plan_id" class="form-control" required>
                                        ...
                                        <?php $__currentLoopData = $plans; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $pl): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($pl->id); ?>"><?php echo e($pl->plan_name); ?></option>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    </select>
                                    <input type="number" class="form-control" name="amount" min="1" step="any"
                                        placeholder="Add Invest Balance" required>
                                    <button class="btn btn-outline-success px-2" type="submit" id="button-addon3"> <i class="fa fa-plus mr-1"></i> <?php echo e(__('Add Invest')); ?></button>
                                </div>
                            </form>
                            ...
                            <form action="<?php echo e(route('admin.user.invest.update', $user->id)); ?>" method="post">
                                ...
                                <div class="input-group mb-3">
                                    ...
                                    <button class="btn btn-outline-danger px-2" type="submit" id="button-addon4"> <i class="fa fa-minus mr-1"></i> <?php echo e(__('Sub Invest')); ?></button>
                                </div>
                            </form>
                        </div>
                        <div class="custom-xxl-9 col-xl-8 col-lg-7">
                            <ul class="user-action-list">
                                <li>
                                    <a href="#" class="btn btn-sm btn-outline-primary sendMail"><i class="fas fa-link mr-1"></i> <?php echo e('Send Email'); ?> </a>
                                </li>
                                <li>
                                ...
                                <li>
                                    <a href="<?php echo e(route('admin.commision', $user)); ?>" class="btn btn-sm btn-outline-primary"><i class="fas fa-link mr-1"></i> <?php echo e('Commission Log'); ?></a>
                                </li>

                                <li>
                                    <a href="<?php echo e(route('admin.user.interestlog', $user)); ?>" class="btn btn-sm btn-outline-primary"><i class="fas fa-link mr-1"></i> <?php echo e('Interest Log'); ?></a>
                                </li>
                                ...
                                <li>
                                    <a href="<?php echo e(route('admin.payment.report', $user)); ?>" class="btn btn-sm btn-outline-primary"><i class="fas fa-link mr-1"></i> <?php echo e('Investment Log'); ?></a>
                                </li>
                                ...
                                <li>
                                    <a href="<?php echo e(route('admin.ticket.index', ['user' => $user->id])); ?>" class="btn btn-sm btn-outline-primary"><i class="fas fa-link mr-1"></i> <?php echo e('User Ticket'); ?></a>
                                </li>

                                <li>
                                    <a href="<?php echo e(route('admin.transaction', $user)); ?>" class="btn btn-sm btn-outline-primary"><i class="fas fa-link mr-1"></i> <?php echo e('User Transactions'); ?></a>
                                </li>
                            </ul>
...
<?php echo $__env->make('backend.layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/sites/nestvest/core/resources/views/backend/users/details.blade.php ENDPATH**/ ?>