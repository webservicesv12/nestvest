                    ...
                    <form action="" method="post" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            <div class="form-group col-md-3 mb-3">
                                <label class="col-form-label"><?php echo e(__('mercadopago Image')); ?></label>
                            ...
                            <div class="col-md-9">
                                <div class="row">
                                    ...
                                    <div class="form-group col-md-12">
                                        ...
                                        <label for=""><?php echo e(__('mercadopago Access Token')); ?></label>
                                        <input type="text" name="access_token" class="form-control"

                                            value="<?php echo e(@$gateway->gateway_parameters->access_token ?? old('access_token')); ?>">
                                    </div>
                                    
                                    <div class="form-group col-md-12">

                                        <label for=""><?php echo e(__('mercadopago Public Key')); ?></label>
...
<?php echo $__env->make('backend.layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\hyip_v7\core\resources\views/backend/gateways/mercadopago.blade.php ENDPATH**/ ?>