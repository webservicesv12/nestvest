                            ...
                            <form action="" method="post" enctype="multipart/form-data">
                                ...
                                <div class="row">
                                    <div class="form-group col-md-3 mb-3">
                                        <label class="col-form-label"><?php echo e(__('Paghiper Image')); ?></label>
                                    ...
                                    <div class="col-md-9">
                                        <div class="row">
                                            ...
                                            <div class="form-group col-md-12">
                                                ...
                                                <label for=""><?php echo e(__('Paghiper API Key')); ?></label>
                                                <input type="text" name="paghiper_key" class="form-control"
                                                    value="<?php echo e(@$gateway->gateway_parameters->paghiper_key ?? old('paghiper_key')); ?>">
                                            </div> 
                                            ...
                                            <div class="form-group col-md-12">
                                                ...
                                                <label for=""><?php echo e(__('Paghiper Token')); ?></label>
                                                <input type="text" name="token" class="form-control"
                                                    value="<?php echo e(@$gateway->gateway_parameters->token ?? old('token')); ?>">
                                            </div> 
                                    ...
                                    <div class="col-md-12">
                                        <button type="submit"
                                            class="btn btn-primary float-right"><?php echo e(__('Update Paghiper Information')); ?></button>
                                    </div>
                                </div>
                            </form>
                        </div>
...
<?php echo $__env->make('backend.layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\hyip_v7\core\resources\views/backend/gateways/paghiper.blade.php ENDPATH**/ ?>