<nav class="navbar navbar-expand-lg main-navbar">
    ...
    <form class="form-inline mr-auto">
        ...
        <div class="search-element">
            <a href="<?php echo e(route('home')); ?>" target="_blank" class="bg-primary text-white text-decoration-none p-2 rounded"><i class="fas fa-globe-africa  mr-2"></i><span class="font-weight-bold"><?php echo e(__('Visit Site')); ?></span></a>
        </div>
    </form>
    ...
    <ul class="navbar-nav navbar-right">
        ...
        <li class="dropdown dropdown-list-toggle"><a href="#" data-toggle="dropdown"
            class="nav-link notification-toggle nav-link-lg"> <i class="fas fa-ticket-alt"></i> <span
                class="badge badge-danger notification-badge"><?php echo e($pendingTicket->count()); ?></span> </a>
        <div class="dropdown-menu dropdown-list dropdown-menu-right">
            ...
            <div class="dropdown-list-content dropdown-list-icons">
                <?php $__empty_1 = true; $__currentLoopData = $pendingTicket; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $pendingTicket): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <a href="<?php echo e(route('admin.ticket.pendingList')); ?>"
        ...
        <li class="dropdown dropdown-list-toggle"><a href="#" data-toggle="dropdown"
            class="nav-link notification-toggle nav-link-lg"><i class="fas fa-money-bill-alt"></i> <span
                class="badge badge-danger notification-badge"><?php echo e($pendingWithdraw->count()); ?></span> </a>
        <div class="dropdown-menu dropdown-list dropdown-menu-right">
            <div class="dropdown-header"><?php echo e(__('Notifications')); ?>
        ...
        <li class="dropdown dropdown-list-toggle"><a href="#" data-toggle="dropdown"
                class="nav-link notification-toggle nav-link-lg"><i class="far fa-credit-card"></i> <span
                    class="badge badge-danger notification-badge"><?php echo e($pendingpayment->count()); ?></span> </a>
            <div class="dropdown-menu dropdown-list dropdown-menu-right">
                <div class="dropdown-header"><?php echo e(__('Notifications')); ?>
        ...
        <li class="dropdown dropdown-list-toggle"><a href="#" data-toggle="dropdown"
                class="nav-link notification-toggle nav-link-lg"><i class="far fa-bell"></i> <span
                    class="badge badge-danger notification-badge"><?php echo e($notifications->count()); ?></span> </a>
            <div class="dropdown-menu dropdown-list dropdown-menu-right">
                <div class="dropdown-header"><?php echo e(__('Notifications')); ?>
        ...
        <li class="dropdown dropdown-list-toggle"><a href="#" data-toggle="dropdown"
                class="nav-link notification-toggle nav-link-lg"><i class="fas fa-dollar-sign"></i> <span
                    class="badge badge-danger notification-badge"><?php echo e($depositNotifications->count()); ?></span> </a>
            <div class="dropdown-menu dropdown-list dropdown-menu-right">
                <div class="dropdown-header"><?php echo e(__('Notifications')); ?>
...
<?php /**PATH /var/www/sites/nestvest-mgmt/core/resources/views/backend/layout/navbar.blade.php ENDPATH**/ ?>