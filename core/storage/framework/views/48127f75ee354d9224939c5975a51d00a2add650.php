                                    ...
                                    <div class="col-md-4">
                                        <div class="card">
                                            <div class="card-header p-3 my-1 h4 font-weight-bold">
                                                <?php echo e(__('Gold Template')); ?>

                                            </div>
                                            <div class="card-body m-0 p-0">
                                                <img class="w-100" src="<?php echo e(asset('asset/theme1.png')); ?>"
                                                    alt="theme-image">
                                            </div>
                                            <div class="card-footer">
                                                <button type="button" <?php echo e(@$general->theme == 1 ? 'disabled' : ''); ?>

                                                    class="btn btn-primary btn-block mt-3 active-btn"
                                                    data-route="<?php echo e(route('admin.manage.theme.update', 1)); ?>">
...
<?php echo $__env->make('backend.layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/sites/nestvest-mgmt/core/resources/views/backend/setting/theme.blade.php ENDPATH**/ ?>