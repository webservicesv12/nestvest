                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="invest-plan">
                            ...
                            <div class="invest-plan-action mt-3">
                                <?php if($plan_exist): ?>
                                    <a class="cmn-btn w-100" href="#"><?php echo e(__('Already Invest To This Plan')); ?></a>
                                <?php else: ?>
...
<?php echo $__env->make(template().'layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/sites/nestvest-mgmt/core/resources/views/frontend/pages/investmentplan.blade.php ENDPATH**/ ?>