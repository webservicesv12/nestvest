                            ...
                            <form action="" method="post" enctype="multipart/form-data">
                                ...
                                <div class="row">
                                    <div class="form-group col-md-3 mb-3">
                                        <label class="col-form-label"><?php echo e(__('PayStack Image')); ?></label>
                                    ...
                                    <div class="col-md-9">
                                        <div class="row">
                                            ...
                                            <div class="form-group col-md-12">
                                                ...
                                                <label for=""><?php echo e(__('PayStack Public  Key')); ?></label>
                                                <input type="text" name="paystack_key" class="form-control"
                                                    value="<?php echo e(@$gateway->gateway_parameters->paystack_key ?? old('paystack_key')); ?>">
                                            </div> 
                                    ...
                                    <div class="col-md-12">
                                        <button type="submit"
                                            class="btn btn-primary float-right"><?php echo e(__('Update Paystack Information')); ?></button>
                                    </div>
                                </div>
                            </form>
                        </div>
...
<?php echo $__env->make('backend.layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\hyip_v7\core\resources\views/backend/gateways/paystack.blade.php ENDPATH**/ ?>