...
<section class="transaction-section s-pt-100 s-pb-100">
    <div class="transaction-candle">
        <img src="<?php echo e(getFile('bg', 'transaction.png')); ?>" alt="image">
    </div>
    <div class="container">
        ...
        <div class="transaction-wrapper">
            <div class="transaction-el">
                <img src="<?php echo e(getFile('bg', 'bitcoin.png')); ?>" alt="image">
            </div>
...
<?php /**PATH C:\xampp\htdocs\September\hyip_v7\core\resources\views/theme2/sections/transaction.blade.php ENDPATH**/ ?>