                            ...
                            <form method="POST" action="<?php echo e(route('admin.plan.store')); ?>">
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="form-group col-md-3">
                                        ...
                                        <input type="text" class="form-control" name="name" value="<?php echo e(old('name')); ?>" placeholder="Plan name">
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="form-group return col-md-3 how_many_times">
                                        ...
                                        <input type="number"
                                            class="form-control" name="repeat_time"
                                            vlaue="<?php echo e(old('repeat_time')); ?>" placeholder="How many times"/>
                                  </div>

                                        <div class="form-group col-md-3 capital_back"
                                            id="capitalBack">
...
<?php echo $__env->make('backend.layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\qaitrading\core\resources\views/backend/plan/create.blade.php ENDPATH**/ ?>