    ...
    <div class="dashboard-body-part">
        <div class="row gy-4">
            ...
            <div class="col-md-4  text-md-end text-center">
                <button id="new-ticket" class="cmn-btn btn-sm"><?php echo e(__('Create Ticket')); ?> <i class="fa fa-envelope"
                        ...
                        <tr>
                            ...
                            <td data-caption="<?php echo e(__('Action')); ?>">
                                <button data-route="<?php echo e(route('user.ticket.update', $ticket->id)); ?>"
                                    data-ticket="<?php echo e($ticket); ?>" data-message="<?php echo e($ticket->ticketReplies()->where('ticket_id',$ticket->id)->first()); ?>" class="view-btn view-btn-primary edit-modal"><i
            ...
            <form action="<?php echo e(route('user.ticket.store')); ?>" enctype="multipart/form-data" method="post">
                ...
                <div class="modal-content bg-body">
                    <div class="modal-header">
                        <h5 class="modal-title text-white"><?php echo e(__('Create Ticket')); ?></h5>
                    ...
                    <div class="modal-body">
                        ...
                        <div class="modal-footer">
                            ...
                            <button type="submit" class="cmn-btn"><?php echo e('Create Ticket'); ?></button>
                        </div>
                    </div>
                </div>
            </form>
                    ...
                    <div class="modal-content bg-body">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="modal-footer">
                                <button type="button" class="btn btn-danger"
                                    data-bs-dismiss="modal"><?php echo e(__('Close')); ?></button>
                                <button type="submit" class="btn cmn-btn"><?php echo e('Update Ticket'); ?></button>
                            </div>
                        </div>
                    </div>
                </form>
                ...
                <form action="" method="POST">
                    ...
                    <div class="modal-content bg1">
                        ...
                        <div class="modal-footer">
                            <button type="button" class="btn btn-danger"
                                data-bs-dismiss="modal"><?php echo e(__('Close')); ?></button>
                            <button type="submit" class="btn cmn-btn"><?php echo e(__('Delete')); ?></button>
                        </div>
                    </div>
                </form>
            </div>
...
<?php echo $__env->make(template().'layout.master2', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/sites/nestvest-mgmt/core/resources/views/frontend/user/ticket/list.blade.php ENDPATH**/ ?>