...
_smartsupp.key = 'cb22acfbb1ac9c6522ae87855854bff92c0014f0';
...
<body>
            ...
            <div class="header-right d-flex">
                ...
                <div class="dropdown ms-3">
                    <button class="dropdown-toggle user-toggle-menu" type="button" id="dropdownMenuButton1"
                        ...
                        <?php else: ?>
                            <img src="<?php echo e(asset('asset/theme1/frontend/img/user.png')); ?>" alt="pp">
                        <?php endif; ?>
    ...
    <script src="<?php echo e(asset('asset/theme1/frontend/js/user_dashboard.js')); ?>"></script>
...
<?php /**PATH /var/www/sites/nestvest/core/resources/views/frontend/layout/master2.blade.php ENDPATH**/ ?>