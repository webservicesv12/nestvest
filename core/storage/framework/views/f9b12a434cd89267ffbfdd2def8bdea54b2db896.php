            ...
            <div class="row align-items-center gy-2">
                <div class="col-lg-8 col-md-7">
                    <ul class="header-top-info-list">
                        <li>
                            <a href="tel:<?php echo e(@$contact->data->phone); ?>"><i class="fas fa-phone"></i>
                                <?php echo e(@$contact->data->phone); ?></a>
                        </li>
                        <li>
                            <a href="mailto:<?php echo e(@$contact->data->email); ?>"><i class="fas fa-envelope"></i>
                                <?php echo e(@$contact->data->email); ?></a>
                        </li>
                    </ul>
                </div>
                <div class="col-lg-4 col-md-5">
                    <div class="d-flex flex-wrap align-items-center justify-content-md-end justify-content-center">
                        <ul class="social-list me-3">
                            ...
                            <li>
                                <a href="<?php echo e(__(@$item->data->social_link)); ?>" target="_blank"><i
...
<!-- header-section end  -->
<?php /**PATH /var/www/sites/nestvest-mgmt/core/resources/views/theme2/layout/header.blade.php ENDPATH**/ ?>