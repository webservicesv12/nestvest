                ...
                <li class="nav-item dropdown <?php echo e(@$navManageWithdrawActiveClass); ?>">
                    ...
                    <ul class="dropdown-menu">
                        <li class="<?php echo e(@$subNavWithdrawMethodActiveClass); ?>">
                            <a class="nav-link"
                                href="<?php echo e(route('admin.withdraw')); ?>"><?php echo e(__('Withdraw Method')); ?></a>
                        </li>
...
<?php /**PATH C:\xampp\htdocs\hyip_v7\core\resources\views/backend/layout/sidebar.blade.php ENDPATH**/ ?>