        ...
        <div class="row justify-content-center">
            <div class="col-lg-12">
                <form action="<?php echo e(route('contact')); ?>" method="post" role="form" class="php ">
                    ...
                    <div class="mt-3">
                        <button class="cmn-btn w-100" type="submit"><?php echo e(__('Send Message')); ?></button>
                    </div>
                </form>
            </div>
        </div>
...
<?php /**PATH /var/www/sites/nestvest-mgmt/core/resources/views/frontend/sections/contact.blade.php ENDPATH**/ ?>