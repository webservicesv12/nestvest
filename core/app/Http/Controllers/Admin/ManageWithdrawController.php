...
class ManageWithdrawController extends Controller
{
    ...
    public function accepted()
    {
        ...
        $data['withdrawlogs'] = Withdraw::where('status', 1)->latest()->with('withdrawMethod','user')->paginate(10);
    ...
    public function pending()
    {
        ...
        $data['withdrawlogs'] = Withdraw::where('status', 0)->latest()->with('withdrawMethod','user')->paginate(10);
    ...
    public function rejected()
    {
        ...
        $data['withdrawlogs'] = Withdraw::where('status', 2)->latest()->with('withdrawMethod','user')->paginate(10);
