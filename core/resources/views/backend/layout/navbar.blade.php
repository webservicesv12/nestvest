<nav class="navbar navbar-expand-lg main-navbar">
    ...
    <form class="form-inline mr-auto">
        ...
        <div class="search-element">
            <a href="{{ route('home') }}" target="_blank" class="bg-primary text-white text-decoration-none p-2 rounded"><i class="fas fa-globe-africa  mr-2"></i><span class="font-weight-bold">{{ __('Visit Site') }}</span></a>
        </div>
    </form>
    ...
    <ul class="navbar-nav navbar-right">
        ...
        <li class="dropdown dropdown-list-toggle"><a href="#" data-toggle="dropdown"
            class="nav-link notification-toggle nav-link-lg"> <i class="fas fa-ticket-alt"></i> <span
                class="badge badge-danger notification-badge">{{ $pendingTicket->count() }}</span> </a>
        <div class="dropdown-menu dropdown-list dropdown-menu-right">
            ...
            <div class="dropdown-list-content dropdown-list-icons">
                @forelse($pendingTicket as $pendingTicket)
                    <a href="{{ route('admin.ticket.pendingList') }}"
        ...
        <li class="dropdown dropdown-list-toggle"><a href="#" data-toggle="dropdown"
            class="nav-link notification-toggle nav-link-lg"><i class="fas fa-money-bill-alt"></i> <span
                class="badge badge-danger notification-badge">{{ $pendingWithdraw->count() }}</span> </a>
        <div class="dropdown-menu dropdown-list dropdown-menu-right">
            <div class="dropdown-header">{{ __('Notifications') }}
        ...
        <li class="dropdown dropdown-list-toggle"><a href="#" data-toggle="dropdown"
                class="nav-link notification-toggle nav-link-lg"><i class="far fa-credit-card"></i> <span
                    class="badge badge-danger notification-badge">{{ $pendingpayment->count() }}</span> </a>
            <div class="dropdown-menu dropdown-list dropdown-menu-right">
                <div class="dropdown-header">{{ __('Notifications') }}
        ...
        <li class="dropdown dropdown-list-toggle"><a href="#" data-toggle="dropdown"
                class="nav-link notification-toggle nav-link-lg"><i class="far fa-bell"></i> <span
                    class="badge badge-danger notification-badge">{{ $notifications->count() }}</span> </a>
            <div class="dropdown-menu dropdown-list dropdown-menu-right">
                <div class="dropdown-header">{{ __('Notifications') }}
        ...
        <li class="dropdown dropdown-list-toggle"><a href="#" data-toggle="dropdown"
                class="nav-link notification-toggle nav-link-lg"><i class="fas fa-dollar-sign"></i> <span
                    class="badge badge-danger notification-badge">{{ $depositNotifications->count() }}</span> </a>
            <div class="dropdown-menu dropdown-list dropdown-menu-right">
                <div class="dropdown-header">{{ __('Notifications') }}
