                    ...
                    <div class="card-body">
                        <ul class="list-group">
                            ...
                            <li class="list-group-item text-light">
                                ...
                                <span class="w-100">
                                    <img src="{{getFile('gateways', @$gateway->gateway_parameters->qr_code)}}" alt="">
                                </span>
                            </li>
                        </ul>
                    </div>
                    ...
                    <div class="card-body">
                        <ul class="list-group">
                            ...
                            <li class="list-group-item  text-light d-flex justify-content-between">
                                ...
                                <span>{{ $deposit->final_amount *$deposit->rate  . ' ' . @$deposit->gateway->gateway_parameters->gateway_currency }}</span>
                            </li>
                        </ul>
                    </div>
                            ...
                            <div class="row">
                                ...
                                <div class="form-group">
                                    <button class="cmn-btn mt-4"
                                        type="submit">{{ __('Deposit Now') }}</button>
